...
import Card1 from "../assets/images/photos/main/card/image  1.jpg";
import Card2 from "../assets/images/photos/main/card/image  2.jpg";
import Card3 from "../assets/images/photos/main/card/image  3.jpg";
import Card4 from "../assets/images/photos/main/card/image  4.png";
import Card5 from "../assets/images/photos/main/card/image  5.jpg";
import Card6 from "../assets/images/photos/main/card/image  6.jpg";
import Card7 from "../assets/images/photos/main/card/image  7.jpg";
import Card8 from "../assets/images/photos/main/card/image  8.jpg";
import Card9 from "../assets/images/photos/main/card/image  9.jpg";

const CardList = () => {
  return (
    <div className="w-[67%] sm:w-full">
      <div className="mb-8 flex items-center justify-between sm:mb-5">
        <nav>
          <ul className="flex items-center gap-10 sm:pb-3">
            <li className=" border-b-2 border-[#fff] pb-1 text-[15px] hover:font-bold hover:text-check active:border-check sm:pb-0 sm:text-[14px] lg:pb-[6px]">
              All Plants
            </li>
            <li className=" border-b-2 border-[#fff] pb-1 text-[15px] hover:font-bold hover:text-check active:border-check sm:pb-0 sm:text-[14px] lg:pb-[6px]">
              New Arrivals
        ...
        <div className="flex items-center sm:hidden">
          ...
          <select id="select" className="text-[15px] outline-none">
      ...
      <div className="mb-[60px] grid grid-cols-3 justify-between sm:mb-[50px] sm:grid-cols-2 sm:gap-x-5 sm:gap-y-6 lg:mb-[90px] lg:gap-x-8 lg:gap-y-10">
        <div className="card_item transition duration-500">
          <div className="relative flex items-center justify-center bg-[#FBFBFB] sm:min-h-[200px] sm:rounded-[24px]  lg:min-h-[300px]">
            <img src={Card1} alt="card img" className="object-contain" />
            <div className="cardbtn_group absolute bottom-3 left-[-50%] right-[-50%] z-[13] items-center justify-center gap-2">
              <button className="flex h-9 w-9 items-center justify-center sm:h-7 sm:w-7">
                <svg
                  width="20.000000"
                  height="19.000000"
                  viewBox="0 0 20 19"
          ...
          <p className="text-[18px] font-bold text-check sm:text-[16px]">
            $129.00
          </p>
        </div>
        <div className="card_item">
          <div className="relative flex items-center justify-center bg-[#FBFBFB] sm:min-h-[200px] sm:rounded-[24px]  lg:min-h-[300px]">
            <img src={Card2} alt="card img" className="object-contain" />
          </div>
          <p className="py-3 text-[16px] sm:pb-1 sm:pt-2 sm:text-[15px]">
            Beach Spider Lily
          </p>
        ...
        <div className="card_item">
          <div className="relative flex items-center justify-center bg-[#FBFBFB]  lg:min-h-[300px]">
            <img src={Card3} alt="card img" className="object-contain" />
            <p className="absolute left-0 top-4 z-10 bg-check px-2 py-[6px] text-[16px] font-medium leading-4 text-[white]">
              13% OFF
            </p>
          </div>
          <p className="py-3 text-[16px] sm:pb-1 sm:pt-2 sm:text-[15px]">
        ...
        <div className="card_item">
          <div className="relative flex items-center justify-center bg-[#FBFBFB] sm:min-h-[200px] sm:rounded-[24px]  lg:min-h-[300px]">
            <img src={Card4} alt="card img" className="object-contain" />
          </div>
          <p className="py-3 text-[16px] sm:pb-1 sm:pt-2 sm:text-[15px]">
            Beach Spider Lily
          </p>
        ...
        <div className="card_item">
          <div className="relative flex items-center justify-center bg-[#FBFBFB] sm:min-h-[200px] sm:rounded-[24px]  lg:min-h-[300px]">
            <img src={Card5} alt="card img" className="object-contain" />
          </div>
          <p className="py-3 text-[16px] sm:pb-1 sm:pt-2 sm:text-[15px]">
            Beach Spider Lily
          </p>
        ...
        <div className="card_item">
          <div className="relative flex items-center justify-center bg-[#FBFBFB] sm:min-h-[200px] sm:rounded-[24px]  lg:min-h-[300px]">
            <img src={Card6} alt="card img" className="object-contain" />
          </div>
          <p className="py-3 text-[16px] sm:pb-1 sm:pt-2 sm:text-[15px]">
            Beach Spider Lily
          </p>
        ...
        <div className="card_item">
          <div className="relative flex items-center justify-center bg-[#FBFBFB] sm:min-h-[200px] sm:rounded-[24px]  lg:min-h-[300px]">
            <img src={Card7} alt="card img" className="object-contain" />
          </div>
          <p className="py-3 text-[16px] sm:pb-1 sm:pt-2 sm:text-[15px]">
            Beach Spider Lily
          </p>
        ...
        <div className="card_item">
          <div className="relative flex items-center justify-center bg-[#FBFBFB] sm:min-h-[200px] sm:rounded-[24px]  lg:min-h-[300px]">
            <img src={Card8} alt="card img" className="object-contain" />
          </div>
          <p className="py-3 text-[16px] sm:pb-1 sm:pt-2 sm:text-[15px]">
            Beach Spider Lily
          </p>
        ...
        <div className="card_item ">
          <div className="relative flex items-center justify-center bg-[#FBFBFB] sm:min-h-[200px] sm:rounded-[24px]  lg:min-h-[300px]">
            <img src={Card9} alt="card img" className="object-contain" />
          </div>
          <p className="py-3 text-[16px] sm:pb-1 sm:pt-2 sm:text-[15px]">
            Beach Spider Lily
          </p>
