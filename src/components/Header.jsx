...
const Header = () => {
  ...
  return (
    <header className="border-b-[0.3px] border-[#46A35880] pt-3">
      <div className="flex items-center justify-between">
        ...
        <nav>
          <ul className="flex items-center gap-[30px] md:gap-5">
            ...
            >
              <NavLink to="/shop">
                <p
                  className={`${location.pathname === "/shop" ? "font-bold" : ""} py-[22px] md:py-[16px]`}
                >
                  Shop
                </p>
              </NavLink>
        ...
        <div className="flex gap-6">
          ...
          <button className="flex items-center gap-1 rounded-md bg-[#46A358] px-4 py-[6px] hover:opacity-80 md:px-2 md:py-1">
            <svg
              width="18"
              height="18"
              viewBox="0 0 18 18"
            ...
            <span className="text-[16px] font-medium text-[#fff] md:text-[14px]">
              Login
            </span>
          </button>
        </div>
