  ...
  return (
    <section className="bg-[100%] bg-no-repeat sm:w-full sm:rounded-[30px] sm:bg-[url('./assets/images/back/smHero.svg')]">
      <div className="bg-contain bg-[center] bg-no-repeat sm:bg-[url('./assets/images/main/heroImg.png')]">
        ...
        >
          <SwiperSlide>
            <div className="grid w-full grid-cols-2 items-center gap-12 sm:grid-cols-3 sm:gap-0">
              <div className="pl-12 sm:col-span-2 sm:pb-7 sm:pl-6 sm:pt-6">
                ...
                <p className="mb-11 text-oridinary sm:mb-3">
                  ...
                  <span className="text-oridinary  sm:hidden">
                    of cheap and trendy plants. Use our plants to create an
              ...
              <div className="relative h-full sm:col-span-1">
                ...
                <img
                  src={Vase}
                  alt="hero img small"
                  className="absolute bottom-8 left-0 w-[25%] sm:bottom-3 sm:left-[-24px] sm:hidden sm:w-[50%]"
                />
              </div>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className="grid w-full grid-cols-2 items-center gap-12 sm:grid-cols-3 sm:gap-0">
              <div className="pl-12 sm:col-span-2 sm:pb-7 sm:pl-6 sm:pt-6">
                ...
                <p className="mb-11 text-oridinary sm:mb-3">
                  Transform your living area into a sanctuary of style
                  <span className="text-oridinary  sm:hidden">
                    and comfort with our exquisite collection of home decor
                    essentials.From elegant accents to statement pieces.
                  </span>
                </p>
                <div className="sm:hidden">
                  <Button
          ...
          <SwiperSlide>
            <div className="grid w-full grid-cols-2 items-center gap-12 sm:grid-cols-3 sm:gap-0">
              <div className="pl-12 sm:col-span-2 sm:pb-7 sm:pl-6 sm:pt-6">
                ...
                <p className="mb-11 text-oridinary sm:mb-3">
                  Whether it's a special occasion or just a spontaneous gesture
                  of love
                  <span className="text-oridinary  sm:hidden">
                    , our collection offers something meaningful for every
