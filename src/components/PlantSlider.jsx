...
const PlantSlider = () => {
  ...
  return (
    <section
      className={`mb-32  ${location.pathname === "/shop" ? "mt-32" : "mt-[88px]"} sm:mb-24`}
    >
      ...
      >
        <SwiperSlide>
          <div className="mb-12 grid grid-cols-5 gap-6 sm:hidden">
          ...
          <div className="hidden sm:mb-8 sm:grid sm:grid-cols-2 sm:gap-2">
            {flowers.slice(0, 2).map((flower) => (
              <div className="card_item relative" key={flower.id}>
                <div className=" overflow-hidden sm:max-h-[150px]">
                  <img
                    src={flower.online_img}
                    alt="flower image"
                    className="max-h-full max-w-full object-cover sm:min-h-[149px]"
                  />
                </div>
                <div className="mt-5 sm:mt-2">
                  ...
                  <p className="text-[16px] font-bold text-check sm:text-[14px]">
                    ${flower.price}.00
                  </p>
                </div>
                <div className="cardbtn_group absolute right-2 top-0 z-[20] flex-col items-center justify-center gap-2 sm:bottom-auto sm:left-auto sm:right-1 sm:top-2">
