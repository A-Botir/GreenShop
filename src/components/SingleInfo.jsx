...
import Image from "../assets/images/photos/main/card/image  1.jpg";
...
const SingleInfo = () => {
  ...
  return (
    <section>
      ...
      <div className="mb-24 grid w-full grid-cols-2 gap-[52px]">
        <div className="flex items-start gap-7">
          <div className="flex flex-col justify-center gap-4">
            <button className="max-w-[100px]">
              <img src={Image} alt="first img" className="object-fill" />
            </button>
            <button className="max-w-[100px]">
              <img src={Image} alt="second img" className="object-fill" />
            </button>
            <button className="max-w-[100px]">
              <img src={Image} alt="third img" className="object-fill" />
            </button>
            <button className="max-w-[100px]">
              <img src={Image} alt="fourth img" className="object-fill" />
            </button>
          </div>
        ...
        <div>
          ...
          <div className="mb-4 flex items-center justify-between border-b border-[#46A35880] pb-3">
            <p className="text-[22px] font-bold text-check">$119.00</p>
            <div className="flex items-center gap-2">
              ...
              <p className="text-[15px]">19 Customer Review</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            <p className="text-[15px] font-medium">Share this products:</p>
