        ...
        <div className="flex h-screen items-center justify-center">
          <div className="relative w-[35%] border-b-[10px] border-check bg-[#fff] py-8 sm:w-full sm:border-[none] sm:pb-5 sm:pt-20">
            <div className="mx-auto w-[75%] sm:w-[90%]">
              ...
              <TargetLink
                url={
                  "https://accounts.google.com/v3/signin/identifier?continue=https%3A%2F%2Fmyaccount.google.com%3Futm_source%3Daccount-marketing-page%26utm_medium%3Dgo-to-account-button&ifkv=ARZ0qKIOFbmtTw5oGIp0FMU6kuOfgWG_mMSl611nCSnT38-IAKckJ1aicTu-9GyUXwxXhMv6L5YT&service=accountsettings&flowName=GlifWebSignIn&flowEntry=ServiceLogin&dsh=S2081269632%3A1712453175088965&theme=mn&ddm=0"
                }
              >
                <Button
                  variant="outlined"
              ...
              <TargetLink url={"https://www.facebook.com/"}>
                <Button
                  variant="outlined"
                  color="inherit"
                  startIcon={
